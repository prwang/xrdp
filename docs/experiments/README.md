...
| `70-eager-slot-release-ack.md` | #70 | implementation anchor retained; contaminated timings deleted by #121 |
| `88-client-pauses-are-not-a-port-gate.md` | #88 | WITHDRAWN — external-client diagnosis does not qualify the server port |
| `90-the-eight-ms-prize-was-stale.md` | #90 | WITHDRAWN — single-worker violation and no admissible evidence of sufficient ROI |
...
| `91-the-multimon-window-and-the-shared-pump.md` | #91 | deterministic shared-pump anchor retained; live timing moved to #122 |
...
| `98-tier0-bbr-ab.md` | #98 | WITHDRAWN — scope beyond port; contaminated timing deleted |
...
| `120-perf-trace-shipping.md` | #120 | compile-time-erased trace shipped; producer logger removed |
...
| `125-sparse-chroma-qualification.md` | #125 | OPEN — convergence fixed; flicker documented as sparse limitation; operator surface qualified; 2-by-2 T4 numerical qualification remains |
