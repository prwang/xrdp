...
| `125-sparse-chroma-qualification.md` | #125 | CLOSED — sparse/T4 result retained; exact CPU leaf probe rejects unsupported CAVLC and post-confirm failure is terminal |
