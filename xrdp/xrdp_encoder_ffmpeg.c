 ...
 *
 * External stock-ffmpeg AVC444 process runner.
 *
...
/*****************************************************************************/
/* log a bounded, sanitized line of untrusted ffmpeg stderr     */
static void
...
/*****************************************************************************/
/* Build the exact structural argv plus the low-latency    */
...
/* ------------------------------------------------------------------------ */
/* Bounded behavioral probe. The probe closes its input      */
