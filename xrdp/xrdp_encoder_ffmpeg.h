 ...
 * closes the input and drains the remainder (reset/teardown).
 */
...
/** Populate cfg with the default values (path left empty). */
void
...
/**
 * Bounded behavioral probe: spawn the exact command at the
