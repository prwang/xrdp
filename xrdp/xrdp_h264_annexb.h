 ...
 *
 * This is deliberately NOT a full H.264 parser: it splits
 ...
 * scanning is bounded; the input is treated as untrusted.
 */
...
/**
 * First-packet reset requirement: at least one SPS, one
...
/**
 * Auxiliary packet requirement: at least one VCL NAL unit
