# Slice #215 — Annex-B validation and parameter-set policy
...
* S215-R5: all bit readers, Exp-Golomb values, output growth and NAL counts
...
the README gate. The four auxiliary-leaf cases belong to #221 and shall not be
enabled here.
