# Slice #216 — Pure AVC capability classification
...
* S216-R1: input is the parsed RDPGFX capability version/flags and a requested
...
* S216-R2: RDPGFX v8 has no AVC path. v8.1 permits AVC420 only when its
...
* S216-R3: forced `444` shall choose v2 when the client signals it and
...
* S216-R4: global AVC disable or backend-unavailable input shall return
  unavailable. The classifier shall not fall back to another server codec.
* S216-R5: no symbol in this slice shall make the new backend selectable.
