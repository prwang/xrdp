# Slice #222 — LTR chains, re-key and scheduled intra refresh
...
* S222-R1: main and auxiliary views shall use independent long-term slots and
  counters. A main access unit shall never select the auxiliary slot.
* S222-R2: emitted MMCO and reference-list operations shall match the supported
...
* S222-R3: startup shall seed a valid main chain before any predicted
  auxiliary output. An unseeded auxiliary P picture shall fail loudly.
* S222-R4: frame-number wrap and the configured re-key threshold shall produce
  ...
  only one view.
* S222-R5: main and auxiliary intra schedules shall be independent. Requested
...
* S222-R6: reference rewriting shall copy unchanged payload ranges and patch
  only required syntax. It shall enforce output capacity and be byte-stable
  for an identical input/state pair.
* S222-R7: disabling the optional LTR chain shall preserve #221 topology and
