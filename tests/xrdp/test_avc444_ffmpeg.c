...
/*
 * Executable-behavior test. Gated on the XRDP_TEST_FFMPEG_PATH
...
START_TEST(test_ffmpeg_encode_pair)
{
    ...
    /* REGRESSION GUARDS (both proven in the field):
...
/*
 * Resize lifecycle: a client resize drops the converter and
