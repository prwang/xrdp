...
/* Iso-luminant chroma regression: a 1px column pattern of two equal-luma /
 * opposite-chroma colors (magenta, green). The color detail lives ONLY in
 * chroma, so 4:2:0 must lose it while 4:4:4 keeps it.
 *
